...
const automotiveDesign: Project = {
    ...
    'technologys': [backendTools.springBoot, frontendTools.react, backendTools.mysql],
    'type': 'laboral',
    'inProgress': true,
...
const uberto: Project = {
    ...
    'technologys': [backendTools.springBoot, frontendTools.react, backendTools.postgresql],
    'type': 'facultad',
    'inProgress': false,
    'githubRepoLink': 'https://github.com/AdrianPerez0306',
    'hosted': false,
